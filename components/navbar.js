    ...
    <div class="flex container mx-auto w-full flex-wrap items-center justify-between">
      ...
      <div className={`w-full items-center justify-between md:order-1 md:flex md:w-auto  ${ navBar? 'block': 'hidden' }`} id="navbar-sticky">
        <ul class="flex mt-4 flex-col roundedlg border border-gray-700 p-4 md:mt-0 md:flex-row md:space-x-8 md:border-0 md:text-sm md:font-medium bg-zinc-900">
          <li>
            <a href="/" class="group transition duration-300 rounded py-2 pl-3 pr-4 text-white border-gray-700 md:p-0">Home
            <span class="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-gray-100"></span>
            </a>
          </li>
          <li>
            <a href="/press" class=" group transition duration-300 rounded py-2 pl-3 pr-4 text-white  border-gray-700 md:p-0">Press
            <span class="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-gray-100"></span>
            </a>
          </li>
          <li>
            <a href="/upcoming" class="group transition duration-300 rounded py-2 pl-3 pr-4 text-white  border-gray-700 md:p-0">Upcoming
            <span class="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-gray-100"></span>
            </a>
          </li>
          <li>
            <a href="/contact" class="group transition duration-300 rounded py-2 pl-3 pr-4 text-white  border-gray-700 md:p-0">Contact
            <span class="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-gray-100"></span>
            </a>
          </li>
        </ul>
